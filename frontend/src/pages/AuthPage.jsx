    ...
    <div className="auth-page">
      ...
      <div className="auth-form-panel">
        <div className="auth-card">
          ...
          {/* Google Sign-In — redirect mode (works on mobile data) */}
          <div className="google-signin-wrap">
            ...
            <button
              type="button"
              onClick={() => { setGoogleError(""); startGoogleLogin(); }}
              style={{
              ...
              onMouseOver={e => e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,0,0,0.14)"}
